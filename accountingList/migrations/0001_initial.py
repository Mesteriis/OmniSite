# Generated by Django 2.1.15 on 2020-06-15 09:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='idClient',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='accountingList.ClientFirm', verbose_name='Фирма клиента'),
        ),
        migrations.AddField(
            model_name='accountinglist',
            name='idPromisedPayment',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to='accountingList.promisedPayment', verbose_name='Обещанный платеж'),
        ),
    ]
